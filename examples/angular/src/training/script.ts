import type { TrainingScript } from '@ddocbot/element';

export const trainingScript: TrainingScript = {
  id: 'cadastro-cliente-angular',
  version: 1,
  title: 'Seu primeiro cadastro com Angular',
  steps: [
    {
      id: 'welcome',
